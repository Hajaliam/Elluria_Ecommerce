...
const swaggerOptions = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'API documentation for the Lamora online e-commerce platform.',
            contact: {
                name: 'Alireza Doosti',
            ...
            schemas: {
                Category: {
                    ...
                    properties: {
                        ...
                        description: {
                            type: 'string',
                            description: 'A brief description of the category. It can be null.'
                        },
                        createdAt: {
                            type: 'string',
                            format: 'date-time',
                ...
                Product: {
                    ...
                    properties: {
                        ...
                        description: {
                            type: 'string',
                            description: 'Detailed description of the product. It can be null.'
                        },
                        price: {
                            type: 'number',
                            format: 'float',
                ...
                CartItem: {
                    ...
                    properties: {
                        ...
                        status: {
                            type: 'string',
                            description: 'Stock status of the item (e.g., available, out_of_stock_partial, out_of_stock_full)',
                            example: 'available'
                        }
                    }
                },
                ...
                CouponInput: {
                    ...
                    properties: {
                        ...
                        discount_value: {
                            type: 'number',
                            format: 'float',
                            description: 'Value of the discount (e.g., 10 for 10% or 20 for $20)',
                            example: 10
                        },
                        min_amount: {
                            type: 'number',
                        ...
                        usage_limit: {
                            type: 'integer',
                            nullable: true,
                            description: 'Maximum number of times this coupon can be used overall',
                            example: 100
                        },
                        expiry_date: {
                            type: 'string',
                ...
                OnlineShoppingAdvice: {
                    ...
                    properties: {
                        ...
                        user_id: {
                            type: 'integer',
                            nullable: true,
                            description: 'ID of the user who initiated the advice (null for AI responses or guests without user_id)',
                            example: 1
                        },
                        session_id: {
                            type: 'string',
                            nullable: true,
                            description: 'Session ID for guest users or to link AI responses to a session',
                        ...
                        object: {
                            type: 'string',
                            nullable: true,
                            description: 'Related topic or object of the advice (e.g., product name, category)',
