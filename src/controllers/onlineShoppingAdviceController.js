...
exports.getAllAdvice = async (req, res) => {
    try {
        ...
        res.status(500).json({ message: 'Server error fetching advice requests', error: error.message });
    }
};
...
exports.getAdviceById = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Server error fetching advice request', error: error.message });
    }
};
...
exports.updateAdvice = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Advice request updated successfully!', advice: advice });
    } catch (error) {
        console.error('Error updating advice request:', error);
        res.status(500).json({ message: 'Server error updating advice request', error: error.message });
    }
};
...
exports.deleteAdvice = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Server error deleting advice request', error: error.message });
    }
};